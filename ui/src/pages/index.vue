                                ...
                                <button
                                    ...
                                    :class="loading[course.id]
                                        ? `
                                            ...
                                            justify-center gap-2 truncate rounded-md px-4 py-2 text-red-400 opacity-50
                                            outline-[1.5px] outline-red-400/20 transition
                                            hover:bg-red-400/20
                                        `
                                        : `
                                            line-clamp-1 flex cursor-pointer items-center justify-center gap-2 truncate
                                            rounded-md px-4 py-2 text-red-400 outline-[1.5px] outline-red-400/20
                                            transition
                                            hover:bg-red-400/20
                                        `"
