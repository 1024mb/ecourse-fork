<script>
    import { courses, lessons, progress, updateProgressStatus } from "../lib/pocketbase";
    import Icon from "@iconify/svelte";
    import slugify from "slugify";
    import { getStoredLessons, isLoading, isSidebarVisible, storeLessons } from "../lib/store";
