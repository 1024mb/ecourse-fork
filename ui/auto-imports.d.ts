...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { User, Course, LessonFaq, LessonResource, Lesson, Status, Progress, Resource, Users, Courses, LessonFaqs, LessonResources, Lessons, Resources } from './src/types/collections.d'
