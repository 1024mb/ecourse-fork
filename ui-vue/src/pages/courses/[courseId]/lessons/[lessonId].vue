...
// TODO:
//      - Make captions/subtitles be given by language. For this, videos or captions (or both) must be an independent
//          collection linked to a lesson (since each lesson can only have one video), if we allow multiple videos per lesson
//          then each video will have to be a record and subtitles will have to be linked to one.
//      - Support embedding images and pdfs too
//      - Maybe add support for post-processing video and subtitle files?
//      - Add option to add an intro to each course, this doesn't count as a lesson
//      - Add option to add quizzes?
//      - Send mail notifications to users on new assigned courses?
